...
@router.get(
    ...
    response=List[dict],
    summary="[Admin] Get Available Teams",
    description="Get list of available teams"
)
@admin_required
def get_teams(request):
    """
    Get all available teams for creating questions.
    """
    ...
    return [
        {
            ...
            "conference": team.conference if hasattr(team, 'conference') else None,
        }
        for team in teams
    ]
...
@router.get(
    "/reference-data/players",
    response=List[dict],
    summary="[Admin] Get Available Players",
    description="Get list of available players"
)
@admin_required
def get_players(request):
    """
    Get all available players for creating questions.
    """
