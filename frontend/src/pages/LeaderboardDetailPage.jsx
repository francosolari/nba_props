                                          ...
                                          <Draggable key={`mobile-W-${row.team}`} draggableId={`mobile-W-${row.team}`} index={idx} isDragDisabled={!whatIfEnabled}>
                                            {(provided, snapshot) => (
                                              <th
                                                ...
                                                className={`sticky z-15 backdrop-blur-sm px-1 py-2 text-center border-b border-slate-200/80 dark:border-slate-700/60 w-[48px] transition-all ${snapshot.isDragging ? 'opacity-50 shadow-xl' : ''
