                  ...
                  {predictions.length === 0 ? (
                    ...
                    <div className="space-y-3">
                      ...
                      {[
                        ...
                        const correctPredictions = typePredictions.filter((p) => p.correct === true);
                        const wrongPredictions = typePredictions.filter((p) => p.correct === false);
                              ...
                              <div>
                                ...
                                <ul className="space-y-1">
                                  ...
                                  {correctPredictions.map((p, i) => (
                                    ...
                                    >
                                      {p.answer}
                                      <span className="ml-1 font-bold">+{p.points.toFixed(1)}</span>
                                    </li>
                                  ))}
                                </ul>
                              </div>
