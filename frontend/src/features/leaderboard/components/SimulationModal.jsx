...
export const SimulationModal = ({ show, onClose, onEnable }) => {
  if (!show) return null;
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-950/60 backdrop-blur-sm p-4">
      <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-2xl w-[95%] max-w-sm max-h-[90dvh] overflow-y-auto p-8 text-center animate-in zoom-in-95 duration-200 my-auto">
        ...
        <p className="text-slate-500 dark:text-slate-400 mb-6 text-sm leading-relaxed font-bold">Drag teams to see how points would change. Real data won't be affected.</p>
